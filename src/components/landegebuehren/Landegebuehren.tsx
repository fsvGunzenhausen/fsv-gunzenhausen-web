  ...
  return (
    <div className="container pb-4">
     <p className="lead mb-5">
        Für Flugzeuge, sebsständige Motorsegler und Ultraleichtflugzeuge gelten die Gebühren gemäß der Gebührenordnung für den Sonderlandeplatz "Gunzenhausen-Reutberg", Flugsportvereinigung "Gelbe Bürg" Gunzenhausen und bemessen sich (Preise incl. 19% MwSt.) nach dem in der in der Zulassungsurkunde des Luftfahrzeugs eingetragenen Höchstgewicht:
      </p>
